...
JOINEDLOCALFILE = SEP.join((CWD,LOCALFILE))
print(JOINEDLOCALFILE)

# Uploads contents of JOINEDLOCALFILE to Dropbox
def backup():
    with open(JOINEDLOCALFILE, 'rb') as f:
        # We use WriteMode=overwrite to make sure that the settings in the file
        # are changed on upload
        print("Uploading " + JOINEDLOCALFILE + " to Dropbox as " + BACKUPPATH + "...")
        try:
